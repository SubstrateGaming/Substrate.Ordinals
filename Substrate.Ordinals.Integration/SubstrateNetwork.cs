...
namespace Substrate.Integration
{
    public partial class SubstrateNetwork : BaseClient
    {
        ...
        /// <param name="token"></param>
        /// <returns></returns>
        public async Task<string> RemarkWithEventAsync(BaseVec<U8> remark, int concurrentTasks, CancellationToken token)
        {
            var extrinsicType = "SystemCalls.RemarkWithEvent";
            ...
            var extrinsic = SystemCalls.RemarkWithEvent(remark);
        ...
        /// <param name="token"></param>
        /// <returns></returns>
        public async Task<string> TransferAllAsync(AccountId32 dest, bool keepAlive, int concurrentTasks, CancellationToken token)
        {
            var extrinsicType = "BalancesCalls.TransferAll";
            ...
            var extrinsic = BalancesCalls.TransferAll(multiAddress, new Bool(keepAlive));
