...
namespace Substrate.Integration.Client
{
    public class ExtrinsicInfo
    {
        ...
        public bool SystemExtrinsicEvent(out Polkadot.NET.NetApiExt.Generated.Model.frame_system.pallet.Event? systemExtrinsicEvent, out string errorMsg)
        {
            systemExtrinsicEvent = null;
            errorMsg = null;

            if (!AllEvents(RuntimeEvent.System, out IEnumerable<Polkadot.NET.NetApiExt.Generated.Model.frame_system.pallet.EnumEvent> allEnumEvents))
            {
                return false;
            }
            ...
            {
                case Polkadot.NET.NetApiExt.Generated.Model.frame_system.pallet.Event.ExtrinsicSuccess:
                    break;

                case Polkadot.NET.NetApiExt.Generated.Model.frame_system.pallet.Event.ExtrinsicFailed:
