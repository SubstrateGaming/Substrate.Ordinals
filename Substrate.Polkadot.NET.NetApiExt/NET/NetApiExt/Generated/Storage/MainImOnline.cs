...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ImOnlineStorage
    {
        ...
        public ImOnlineStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ImOnline", "Keys"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT5)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ImOnline", "AuthoredBlocks"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
        }
        ...
        ///  The current set of keys that may issue a heartbeat.
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT5> Keys(CancellationToken token)
        {
            string parameters = ImOnlineStorage.KeysParams();
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT5>(parameters, token);
            return result;
        }
        ...
        ///  For each session index, we keep a mapping of `SessionIndex` and `AuthIndex`.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.Bool> ReceivedHeartbeats(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32> key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string AuthoredBlocksParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key)
        {
        ...
        ///  number of blocks authored by the given authority.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> AuthoredBlocks(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key, CancellationToken token)
        {
    ...
    public sealed class ImOnlineCalls
    {
        ...
        /// </summary>
        public static Method Heartbeat(Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_im_online.Heartbeat heartbeat, Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_im_online.sr25519.app_sr25519.Signature signature)
        {
