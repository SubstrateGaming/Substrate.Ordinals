...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class MessageQueueStorage
    {
        ...
        public MessageQueueStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("MessageQueue", "BookStateFor"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.inclusion.EnumAggregateMessageOrigin), typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_message_queue.BookState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("MessageQueue", "ServiceHead"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.inclusion.EnumAggregateMessageOrigin)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("MessageQueue", "Pages"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.inclusion.EnumAggregateMessageOrigin, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_message_queue.Page)));
        }
        ...
        /// </summary>
        public static string BookStateForParams(Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.inclusion.EnumAggregateMessageOrigin key)
        {
        ...
        /// </summary>
        public static string PagesParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.inclusion.EnumAggregateMessageOrigin, Substrate.NetApi.Model.Types.Primitive.U32> key)
        {
    ...
    public sealed class MessageQueueCalls
    {
        ...
        /// </summary>
        public static Method ReapPage(Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.inclusion.EnumAggregateMessageOrigin message_origin, Substrate.NetApi.Model.Types.Primitive.U32 page_index)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ExecuteOverweight(Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.inclusion.EnumAggregateMessageOrigin message_origin, Substrate.NetApi.Model.Types.Primitive.U32 page, Substrate.NetApi.Model.Types.Primitive.U32 index, Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight weight_limit)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(message_origin.Encode());
    ...
    public sealed class MessageQueueConstants
    {
        ...
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight> ServiceWeight()
        {
            var result = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight>();
