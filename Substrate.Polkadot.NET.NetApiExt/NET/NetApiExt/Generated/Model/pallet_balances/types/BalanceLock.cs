...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_balances.types
{
    ...
    /// <summary>
    /// >> 499 - Composite[pallet_balances.types.BalanceLock]
    /// </summary>
    ...
    public sealed class BalanceLock : BaseType
    {
        ...
        {
            var start = p;
            Id = new Substrate.Polkadot.NET.NetApiExt.Generated.Types.Base.Arr8U8();
            Id.Decode(byteArray, ref p);
            Amount = new Substrate.NetApi.Model.Types.Primitive.U128();
            Amount.Decode(byteArray, ref p);
            Reasons = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_balances.types.EnumReasons();
