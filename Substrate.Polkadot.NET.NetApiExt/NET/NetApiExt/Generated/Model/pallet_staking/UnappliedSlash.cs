...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_staking
{
    ...
    /// <summary>
    /// >> 530 - Composite[pallet_staking.UnappliedSlash]
    /// </summary>
    ...
    public sealed class UnappliedSlash : BaseType
    {
        ...
        {
            var start = p;
            Validator = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Validator.Decode(byteArray, ref p);
            Own = new Substrate.NetApi.Model.Types.Primitive.U128();
            Own.Decode(byteArray, ref p);
            Others = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>();
