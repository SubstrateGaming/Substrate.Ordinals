...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5
{
    ...
    /// <summary>
    /// >> 719 - Composite[polkadot_primitives.v5.SessionInfo]
    /// </summary>
    ...
    public sealed class SessionInfo : BaseType
    {
        ...
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.ValidatorIndex> _activeValidatorIndices;
        
        /// <summary>
        /// >> random_seed
        /// </summary>
        private Substrate.Polkadot.NET.NetApiExt.Generated.Types.Base.Arr32U8 _randomSeed;
        ...
        /// >> validators
        /// </summary>
        private Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.IndexedVecT1 _validators;
        
        /// <summary>
        /// >> discovery_keys
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_authority_discovery.app.Public> _discoveryKeys;
        
        /// <summary>
        /// >> assignment_keys
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.assignment_app.Public> _assignmentKeys;
        
        /// <summary>
        /// >> validator_groups
        /// </summary>
        private Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.IndexedVecT2 _validatorGroups;
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.ValidatorIndex> ActiveValidatorIndices
        {
            get
            {
        ...
        public Substrate.Polkadot.NET.NetApiExt.Generated.Types.Base.Arr32U8 RandomSeed
        {
            get
            {
        ...
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.IndexedVecT1 Validators
        {
            get
            {
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_authority_discovery.app.Public> DiscoveryKeys
        {
            get
            {
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.assignment_app.Public> AssignmentKeys
        {
            get
            {
        ...
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.IndexedVecT2 ValidatorGroups
        {
            get
            {
        ...
        {
            var start = p;
            ActiveValidatorIndices = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.ValidatorIndex>();
            ActiveValidatorIndices.Decode(byteArray, ref p);
            RandomSeed = new Substrate.Polkadot.NET.NetApiExt.Generated.Types.Base.Arr32U8();
            ...
            Validators = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.IndexedVecT1();
            Validators.Decode(byteArray, ref p);
            DiscoveryKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_authority_discovery.app.Public>();
            DiscoveryKeys.Decode(byteArray, ref p);
            AssignmentKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.assignment_app.Public>();
            AssignmentKeys.Decode(byteArray, ref p);
            ValidatorGroups = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.IndexedVecT2();
