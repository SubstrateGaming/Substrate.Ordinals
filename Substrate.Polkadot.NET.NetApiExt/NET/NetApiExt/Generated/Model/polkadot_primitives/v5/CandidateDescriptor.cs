...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5
{
    ...
    /// <summary>
    /// >> 305 - Composite[polkadot_primitives.v5.CandidateDescriptor]
    /// </summary>
    ...
    public sealed class CandidateDescriptor : BaseType
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            RelayParent = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256();
            RelayParent.Decode(byteArray, ref p);
            Collator = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.collator_app.Public();
            Collator.Decode(byteArray, ref p);
            PersistedValidationDataHash = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256();
            PersistedValidationDataHash.Decode(byteArray, ref p);
            PovHash = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256();
            PovHash.Decode(byteArray, ref p);
            ErasureRoot = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256();
            ErasureRoot.Decode(byteArray, ref p);
            Signature = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.collator_app.Signature();
            Signature.Decode(byteArray, ref p);
            ParaHead = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256();
            ParaHead.Decode(byteArray, ref p);
            ValidationCodeHash = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.ValidationCodeHash();
